...
* Represent the results of the tool in a CSV file (example [here](CSVs/ABIDE_fmriprep_results.csv))
* Generate a dictionary for the results as a CSV file (example [here]())
